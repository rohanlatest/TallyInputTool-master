# Generated by Django 3.2 on 2021-06-23 07:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier_invoice_no', models.CharField(default='', max_length=255)),
                ('supplier_invoice_date', models.DateField(default='')),
                ('supplier_name', models.CharField(default='', max_length=255)),
                ('supplier_state', models.CharField(default='', max_length=255)),
                ('user', models.CharField(default='', max_length=255)),
                ('total_amount', models.IntegerField(default=0)),
                ('naration', models.CharField(default='', max_length=1000)),
        ...
        migrations.CreateModel(
            name='buser',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='admins.user')),
            ],
        ),
        migrations.CreateModel(
            name='hadmin',
